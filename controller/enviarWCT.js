...
async function activos(activoId, receiver, amount) {
    ...
    await WeCoinRes4.methods.FWCT(activoId).call().then(async (dirtoken)=>{
        ...
        return await signTransaction(receiver, amount, addrFWCT, contFWCT);
    });

    async function signTransaction(receiver, amount, addrFWCT, contFWCT) {
        ...
        const value = web3.utils.toWei(amount, 'ether');
         ...
         const tx = {
          ...
          'nonce': nonce,
          'gas': 4800000,
          'data': contFWCT.methods.transfer(receiver, value).encodeABI()
        };
